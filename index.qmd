...
#| echo: false
#| out.width: "90%"
knitr::include_graphics("fig/Fig_prof.png")
```
...
- The predicted medians were generally faster in the typical color condition than in the unrelated color condition. 
