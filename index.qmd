...
- (1) Reaction times will be faster for words presented in typical colors than in unrelated colors.

  - Sentence (L1) > Word (L1) > Sentence (L2) > Word (L2)

- (2) The magnitude of the Stroop effect will be modulated by L2 proficiency during L2 task performance.

  - Higher L2 proficiency > Lower

## Participants
- 24 Japanese learners of English were recruited at a Japanese university. 

  - The university is identical to the one in Terai (2026)
